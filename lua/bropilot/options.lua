...
---@alias BroOptions { provider: "ollama" | "codestral" | "mistral" | "gemini" | "deepseek", ls_version: string, ls_cmd?: string[], api_key?: string, auto_suggest?: boolean, excluded_filetypes?: string[], model?: string, model_params?: ModelParams, debounce: number, keymap: KeymapParams, ollama_url: string }
